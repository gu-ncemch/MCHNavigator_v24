...
if(isset($Competencies)){
	...
	$find->addFindCriterion('Competencies_v4', $Competencies);
}
...
<div class="four columns">
	...
	<form method="get" action="results.php">
		...
		<p class="form-group select">
			<label class="label" for="PHCompetencies">Competency:</label>
			<span class="arr"></span>
		...
		<p class="form-group select">
			<label class="label" for="PHCompetencies">Sorted By:</label>
			<span class="arr"></span>
			<select name="sort">
