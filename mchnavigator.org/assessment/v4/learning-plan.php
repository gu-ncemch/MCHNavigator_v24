...
<?php include('../../incl/title.html'); ?>
    ...
    <div id="printarea">
        ...
        <p>For each competency, a short summary of the relative importance of that topic and your knowledge and skills is presented; you can click below to see details for each sub-competency. Based on how you answered the self-assessment questions, learning opportunities have been chosen from the database based on your reported level of knowledge or skill. You can follow the links to access these trainings externally from the MCH Navigator website.</p>
        ...
        <div class="panel">
          ...
          <ul>
            ...
            <li><strong>Return to this plan</strong> over time to continually expand your knowledge and skills, track your learning over time, and to stay motivated.</li></ul></div>
      ...
      <div id="container" style="height: 400px; margin: 2rem 0" class="noprint"></div>
        ...
        <h2 class="superheader">Competency 6: Negotiation and Conflict Resolution</h2>
            <?php getPlan(6); ?>
        <h2 class="superheader">Competency 7: Cultural Competency</h2>
            <?php getPlan(7); ?>
        <h2 class="superheader">Competency 8: Family-Professional Partnerships</h2>
            <?php getPlan(8); ?>
        <h2 class="superheader">Competency 9: Developing Others Through Teaching, Coaching, and Mentoring</h2>
            <?php getPlan(9); ?>
        ...
        <h2 class="superheader">Competency 11: Working with Communities and Systems</h2>
            <?php getPlan(11); ?>
        ...
        $(function () {
            $('#container').highcharts({
                ...
                xAxis: [{
                    categories: ['1: MCH Knowledge Base/Context', '2: Self-Reflection', '3: Ethics', '4: Critical Thinking', '5: Communication', '6: Negotiation and Conflict Resolution', '7: Cultural Competency', '8: Family-Professional Partnerships', '9: Developing Others Through Teaching, Coaching and Mentoring', '10: Interdisciplinary/Interprofessional Team Building', '11: Working with Communities and Systems', '12: Policy'],
                    type: 'linear',
