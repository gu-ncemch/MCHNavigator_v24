...
<map name="Map" id="Map">
	...
	<area shape="circle" coords="441,92,26" href="competency_07.php<?php echo $urlappend; ?>" alt="Competency 7: Cultural Competency" />
	...
	<area shape="circle" coords="637,53,26" href="competency_11.php<?php echo $urlappend; ?>" alt="Competency 11: Working with Communities and Systems" />
...
<p><button class="btnesque" type="button" onclick="javascript:nextModule();">Continue</button></p>
