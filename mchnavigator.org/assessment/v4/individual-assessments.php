...
<div class="container" style="margin-top: 2rem; margin-bottom: 2rem;">
	...
	<div class="nine columns">
		...
		<ul>
			...
			<li><span style="color: #9A0019">REFLECT</span> on how IMPORTANT each competency is to you (Importance: None, Low, Medium, or High).</li>
			<li><span style="color: #9A0019">RESPOND</span> with your current level of KNOWLEDGE and your current SKILL SET for each statement (Knowledge/Skills: None, Low, Medium, or High).</li>
		</ul>
		<?php
	// get questions
...
?>
		...
		<div id="progressTOC">
			...
			<ul>
				...
				<li><?php complete(); ?><a href="competency_07.php"><strong>Competency 7:</strong> Cultural Competency</a></li>
				<li><?php complete(); ?><a href="competency_08.php"><strong>Competency 8:</strong> Family-Professional Partnerships</a></li>
				<li><?php complete(); ?><a href="competency_09.php"><strong>Competency 9:</strong> Developing Others Through Teaching, Coaching, and Mentoring</a></li>
			...
			<ul>
				<li><?php complete(); ?><a href="competency_11.php"><strong>Competency 11:</strong> Working with Communities and Systems</a></li>
