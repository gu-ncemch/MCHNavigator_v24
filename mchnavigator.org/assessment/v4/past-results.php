...
<?php } ?>
<p>Competencies that you have taken are marked with a check <img src="../checkmark.gif"  class="status" alt="checked">. </p>
<?php
	// get questions
...
<h4><?php complete(); ?>
	<strong>Competency 1:</strong> MCH Knowledge Base/Context</h4>
<?php pastResults(); ?>
<h4><?php complete(); ?>
	<strong>Competency 2:</strong> Self-Reflection</h4>
<?php pastResults(); ?>
<h4><?php complete(); ?>
	<strong>Competency 3:</strong> Ethics and Professionalism</h4>
<?php pastResults(); ?>
<h4><?php complete(); ?>
	<strong>Competency 4:</strong> Critical Thinking</h4>
<?php pastResults(); ?>
<h3>Others</h3>
<h4><?php complete(); ?>
	<strong>Competency 5:</strong> Communication</h4>
<?php pastResults(); ?>
<h4><?php complete(); ?>
	<strong>Competency 6:</strong> Negotiation and Conflict Resolution</h4>
<?php pastResults(); ?>
<h4><?php complete(); ?>
	<strong>Competency 7:</strong> Cultural Competency</h4>
<?php pastResults(); ?>
<h4><?php complete(); ?>
	<strong>Competency 8:</strong> Family-Centered Care</h4>
<?php pastResults(); ?>
<h4><?php complete(); ?>
	<strong>Competency 9:</strong> Developing Others Through Teaching and Mentoring</h4>
<?php pastResults(); ?>
<h4><?php complete(); ?>
	<strong>Competency 10:</strong> Interdisciplinary Team Building</h4>
<?php pastResults(); ?>
<h3>Wider Community</h3>
<h4><?php complete(); ?>
	<strong>Competency 11:</strong> Working with Communities and Systems</h4>
<?php pastResults(); ?>
<h4><?php complete(); ?>
	<strong>Competency 12:</strong> Policy and Advocacy</h4>
<?php pastResults(); ?></div>
