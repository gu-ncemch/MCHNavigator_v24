...
<div class="container" style="margin-top: 2rem; margin-bottom: 2rem;">
	...
	<div class="nine columns">
		...
		<p><strong><img src="../../images/competency10.jpg" alt="Team Building" class="right border">Definition.</strong> MCH systems are <em>interdisciplinary/interprofessional (ID/IP)</em> in nature. ID/IP practice provides a supportive environment in which the skills and expertise of team members from different disciplines, including a variety of professionals and community partners, are acknowledged and seen as essential and synergistic. Input from each team member is elicited and valued in making collaborative, outcome-driven decisions to address individual, community-level, or systems-level problems.</p>
        <p>Members of an ID/IP team may include a variety of professionals, team leaders, and community partners. The "team", which is the core of ID/IP practice, is characterized by mutual respect among stakeholders, shared leadership, collaborative investment in the process, and collective responsibility for outcomes.</p>
