...
<p>A user with that email address already exists. <a href="http://mchnavigator.org/smart/account/">Click here to login</a>.
...
<?php } else { ?>
<p>Your account has successfully been saved. Please click here to <a href="../dashboard.php">access your dashboard and begin the MCHsmart curriculum</a>.
	<!--" . $result->getMessage() . " -->
